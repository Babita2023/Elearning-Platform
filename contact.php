...
<h2 class="text-center mb-4">Contact US</h2> <!-- Contact Us Heading -->
      <div class="row">  <!--Start Contact Us Row-->
        ...
        <div class="col-md-4 stripe text-white text-center" style=" background-image: linear-gradient(240deg, #ed213a, #93291e); border-radius:40px;"> 
          <h4>SKILLXHUB</h4>
          <p> Near GorkhaDepartment,Damak
         Phone:9817824561  <br />
         WWW.SKILLXHUB.com</p>
