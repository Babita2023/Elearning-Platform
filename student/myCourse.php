...
?>
 ...
 <div class="container col-sm-6  mt-5 ml-2">
  <div class="row">
   <div class="jumbotron">
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <p class="card-text d-inline">Price: <small><del>&#8360 <?php echo $row['course_original_price'] ?> </del></small> <span class="font-weight-bolder">&#8360 <?php echo $row['course_price']?> <span></p>
