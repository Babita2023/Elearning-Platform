 ...
 <footer class="container-fluid bg-dark text-center p-2">
    ...
    <small class="text-white fixed-button">Copyright &copy; 2023 || Designed By SKILLXHUB || <?php   
...
$(document).ready(function(){
        ...
        function showSlide(index) {
            slides.hide().slice(index, index + 3).show();
        }
        ...
        showSlide(currentIndex); // Show initial slides
    });
