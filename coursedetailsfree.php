              ...
              echo ' 
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <form action="checkoutfree.php" method="post">
                      <p class="card-text d-inline">Price: <small><del>&#8360 '.$row['course_original_price'].'</del></small> <span></p>
                      <input type="hidden" name="id" value='. $row["course_price"] .'> 
                      <button type="submit" class="btn btn-primary text-white font-weight-bolder float-right" name="buy">Enrol Free</button>
                    </form>
                  </div>
                </div>
              ';
