...
?>
  <div class="col-sm-9 mt-5">
    <!--Table-->
    <p class=" text-white p-2 text-center"  style=" background-color:#225470;">List of Students</p>
    <?php
 ...
 <div><a class="btn btn-danger box" href="addnewstudent.php"><i class="fas fa-plus fa-1x"> </i>  Add</a></div>
