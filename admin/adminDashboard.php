...
?>
  ...
  <div class="col-sm-9 mt-0 ">
    ...
    <div class="row mx-10 mt-5 text-center " style="background-color:skyblue; margin:1px 1px 1px 1px;">
    ...
    <div class="mx-5 mt-5 text-center">
      <!--Table-->
      <p class="text-white p-2" style=" background-color:#225470;">Course Ordered </p>
      <?php
      $sql = "SELECT * FROM courseorder";
      $result = $conn->query($sql);
  ...
  echo '<table class="table">
    <thead>
    <tr style="background-color:#225470; color:#fff;">
    ...
    echo '<tr>';
      ...
      echo '<td><form action="" method="POST" class="d-inline"><input type="hidden" name="id" value='. $row["co_id"] .'>
